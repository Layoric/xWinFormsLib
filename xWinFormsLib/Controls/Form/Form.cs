...
namespace xWinFormsLib
{
    public class Form: Control, iForm
    {
        ...
        {
            content = new ContentManager(FormCollection.Services, "Content");
            ...
            resolveTexture = new RenderTarget2D(FormCollection.Graphics.GraphicsDevice,
        ...
        public void Render()
        {
            ...
            FormCollection.Graphics.GraphicsDevice.SetRenderTarget(resolveTexture);
            ...
            FormCollection.Graphics.GraphicsDevice.SetRenderTarget(null);
